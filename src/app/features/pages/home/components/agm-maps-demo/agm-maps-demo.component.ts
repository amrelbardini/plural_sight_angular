...
@Component({
  selector: 'app-agm-maps-demo',
  templateUrl: './agm-maps-demo.component.html',
  styleUrls: ['./agm-maps-demo.component.scss']
})
export class AgmMapsDemoComponent implements  AfterViewInit {
  ...
  async initMap() {
    ...
    for (const property of this.properties) {
      ...
      advancedMarker.addListener('click', () => {
        this.toggleHighlight(advancedMarker, property);
      });
    }
  }

  toggleHighlight(markerView: google.maps.marker.AdvancedMarkerElement, property: any) {
    console.log('toggleHighlightCalled');
    const contentElement = markerView.content as HTMLElement;
  if (contentElement.classList.contains('highlight')) {
